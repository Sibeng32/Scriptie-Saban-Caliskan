...
figfolder = "/Users/sab/Documents/GitHub/Scriptie-Saban-Caliskan/Figures/20250321/016_031"
...
# Settings
exclude_indices = {0: [], 1: [], 2: [], 3: [59]}
exclude_last_n_points = 0
min_detections = 4  # min number of reps where a radius must be found
