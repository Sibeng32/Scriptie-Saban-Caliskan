...
# Paths
datafolder = "//Users/sab/Desktop/Scriptie-Saban-Caliskan/Contrast_Method/Radii/20250320"
figfolder = "/Users/sab/Desktop/Scriptie-Saban-Caliskan/Contrast_Method/Figures/20250320/024_039"
...
exclude_last_n_points = 36
min_detections = 2  # min number of reps where a radius must be found
...
plt.xscale('log')
plt.xlabel("Pulse energy [pJ]")
plt.xlim([0.9*1e5, 1.1*1e6])
plt.ylim([-1, 70])
plt.ylabel(r"Radius$^2$ [$\mu$m$^2$]")
plt.title(f"Liu Plots for Radius of Surface Ablation of {materiaal}")
